    ...
    const i = t.trim().toLowerCase().split(' '),
      ...
      m = c => {
        ...
        for (const a of c.children)
          a.kind === 'case' ? n(a) && f.push(a) : (m(a), (a.children.length || a.hasLoadErrors) && f.push(a));
        c.children = f;
      };
    m(this.rootItem);
  }
...
function Tt(o) {
  ...
  o.kind === 'group' &&
    o.children.sort((n, m) => n.location.file.localeCompare(m.location.file) || n.location.line - m.location.line);
...
const de = ({ source: o }) => {
    const [t, e] = At(),
      [s, i] = K.useState(Ut()),
      [d] = K.useState(
        Wt(() => import('./assets/xtermModule-CsJ4vdCR.js'), __vite__mapDeps([0, 1]), import.meta.url).then(
          m => m.default,
        ),
      ),
      n = K.useRef(null);
      ...
      render: h => {
        ...
        return r.jsxs('div', {
          ...
          children: [
            ...
            !!h.duration &&
              h.status !== 'skipped' &&
              r.jsx('div', { id: M, className: 'ui-mode-tree-item-time', children: qt(h.duration) }),
            r.jsxs(H, {
              noMinHeight: !0,
              noShadow: !0,
              children: [
        ...
        return (
          (f.current = setTimeout(async () => {
            try {
              ...
              const k = new St('', []);
              (k.errorDescriptors.push(...l.errors.flatMap(N => (N.message ? [{ message: N.message }] : []))),
                n({ model: k, isLive: !1 }));
            } finally {
              c(m + 1);
            }
        ...
        !pt &&
          r.jsxs('dialog', {
            ...
            children: [
              r.jsxs('div', {
                className: 'title',
                children: [r.jsx('span', { className: 'codicon codicon-lightbulb' }), 'Install browsers'],
              }),
              r.jsxs('div', {
                className: 'body',
                children: [
        ...
        jt &&
          r.jsxs('div', {
            ...
            children: [
              ...
              r.jsxs('div', {
                children: [
                  r.jsx('a', { href: '#', onClick: () => (window.location.href = '/'), children: 'Reload the page' }),
                  ' to reconnect',
                ],
              }),
            ],
                ...
                children: [
                  ...
                  !L &&
                    ...
                    r.jsx('div', {
                      ...
                      children: r.jsxs('div', {
                        children: [x.passed, '/', x.total, ' passed (', ((x.passed / x.total) * 100) | 0, '%)'],
                      }),
                    }),
                  L &&
                    x &&
...
(async () => {
  if ((te(), window.location.protocol !== 'file:')) {
    if (
      (window.location.href.includes('isUnderTest=true') && (await new Promise(o => setTimeout(o, 1e3))),
