    ...
    ha ||
      ...
      (function (At, Ot) {
        (function (C, De) {
          ...
          function ne(e, t) {
            for (var n = e.split(' '), r = 0; r < n.length; r++) n[r] && !q(n[r]).test(t) && (t += ' ' + n[r]);
            return t;
          }
          var p = function (e) {
            e.select();
          ...
          function O(e, t) {
            var n;
            return (Object.create ? (n = Object.create(e)) : ((U.prototype = e), (n = new U())), t && Te(t, n), n);
          }
          var ze =
            /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
          function he(e) {
          ...
          var mi = (function () {
            ...
            return function (u, h) {
              ...
              for (var ie = 0, V = v; ie < k; ++ie) {
                var ue = y[ie];
                ue == '1' && V == 'r' ? (y[ie] = 'n') : o.test(ue) && ((V = ue), ue == 'r' && (y[ie] = 'R'));
              }
              ...
              for (var Ke = 0; Ke < k; ++Ke) {
                ...
                if (st == ',') y[Ke] = 'N';
                  ...
                  for (
                    var Mt = (Ke && y[Ke - 1] == '!') || (Xe < k && y[Xe] == '1') ? '1' : 'N', wt = Ke;
                    wt < Xe;
                    ++wt
                  )
                    y[wt] = Mt;
          ...
          function Wn(e) {
            if (Or == null) {
              ...
              (G(e, d('span', [t, document.createTextNode('x')])),
                e.firstChild.offsetHeight != 0 && (Or = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && W < 8)));
            }
...
`,
            ...
            (Je.prototype.column = function () {
              return (
                this.lastColumnPos < this.start &&
                  ...
                  (this.lastColumnPos = this.start)),
                this.lastColumnValue - (this.lineStart ? Ce(this.string, this.lineStart, this.tabSize) : 0)
              );
            }),
          ...
          ((Xt.prototype.lookAhead = function (e) {
            ...
            (Xt.fromSaved = function (e, t, n) {
              return t instanceof _n ? new Xt(e, Gt(e.mode, t.state), n, t.lookAhead) : new Xt(e, Gt(e.mode, t), n);
            }),
          ...
          function bo(e, t, n, r) {
            ...
            for (r && (h = []); (r || u.pos < t.ch) && !u.eol(); )
              ((u.start = u.pos), (l = ki(o, u, s.state)), r && h.push(new yo(u, l, Gt(i.mode, s.state))));
            ...
            if (l)
              for (var a = 0; a < l.length; ++a) {
                ...
                if (s.marker.collapsed) {
                  ...
                  if (
                    !((h >= 0 && v <= 0) || (h <= 0 && v >= 0)) &&
                    ((h <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? re(u.to, n) >= 0 : re(u.to, n) > 0)) ||
                      (h >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? re(u.from, r) <= 0 : re(u.from, r) < 0)))
                  )
                    return !0;
                }
              }
            ...
            if (n) {
              for (var r = void 0, i = 0; i < n.length; ++i)
                if (((r = n[i]), !!r.marker.collapsed)) {
                  ...
                  if (!r.marker.widgetNode && r.from == 0 && r.marker.inclusiveLeft && Ti(e, t, r)) return !0;
                }
            }
          }
          function Ti(e, t, n) {
          ...
          function No(e, t) {
            ...
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
              ...
              ((r.pos = 0),
                (r.addToken = os),
                sr(e.display.measure) && (l = We(o, e.doc.direction)) && (r.addToken = as(r.addToken, l)),
                (r.map = []));
              var a = t != e.display.externalMeasured && f(o);
              (ss(o, r, mo(e, o, a)),
                o.styleClasses &&
                  (o.styleClasses.bgClass && (r.bgClass = ne(o.styleClasses.bgClass, r.bgClass || '')),
                  o.styleClasses.textClass && (r.textClass = ne(o.styleClasses.textClass, r.textClass || ''))),
...
`
              ...
              if (((e.trailingSpace = a.charCodeAt(t.length - 1) == 32), n || r || i || u || o || l)) {
                ...
                var V = d('span', [h], ie, o);
                if (l)
                  for (var ue in l) l.hasOwnProperty(ue) && ue != 'style' && ue != 'class' && V.setAttribute(ue, l[ue]);
          ...
          function ss(e, t, n) {
            ...
            for (var a = i.length, s = 0, u = 1, h = '', v, k, y = 0, E, H, Z, Q, ie; ; ) {
              if (y == s) {
                ...
                if (ue) for (var st = 0; st < ue.length; st += 2) ue[st + 1] == y && (H += ' ' + ue[st]);
                if (!Q || Q.from == s) for (var Xe = 0; Xe < V.length; ++Xe) Oo(t, 0, V[Xe]);
                if (Q && (Q.from || 0) == s) {
                  if ((Oo(t, (Q.to == null ? a + 1 : Q.to) - s, Q.marker, Q.from == null), Q.to == null)) return;
                  Q.to == s && (Q = !1);
                }
              }
              if (s >= a) break;
          ...
          function Wo(e, t, n) {
            if ((Ho(e, t.line, t, n, !0), t.rest)) for (var r = 0; r < t.rest.length; r++) Ho(e, t.rest[r], t, n, !1);
          }
          ...
          function ks(e, t, n, r) {
            ...
            if (o.nodeType == 3) {
              for (var h = 0; h < 4; h++) {
                ...
                for (; i.coverStart + a < i.coverEnd && Ee(t.line.text.charAt(i.coverStart + a)); ) ++a;
                if (
            ...
            for (
              var y = u.top - t.rect.top, E = u.bottom - t.rect.top, H = (y + E) / 2, Z = t.view.measure.heights, Q = 0;
              Q < Z.length - 1 && !(H < Z[Q]);
              Q++
            );
            var ie = Q ? Z[Q - 1] : 0,
              ...
              E = Pt(
                function (be) {
                  ...
                  return (
                    (me.top += l),
                    (me.bottom += l),
                    Pi(me, r, i, !1) ? (me.top <= i && me.left <= r && ((k = be), (y = me)), !0) : !1
                  );
                },
                a,
                s,
          ...
          function Ls(e, t, n, r, i, o, l) {
            var a = Pt(
                function (v) {
                  var k = i[v],
                    y = k.level != 1;
                  return Pi(jt(e, D(n, y ? k.to : k.from, y ? 'before' : 'after'), 'line', t, r), o, l, !0);
                },
                0,
                i.length - 1,
              ),
            ...
            function v(V, ue, be) {
              ...
              function Mt(tt, St, ft) {
                var nt = Vo(e, me, null, tt),
                  ...
                  Qe = ft == 'after' ? nt.begin : nt.end - (/\s/.test(me.text.charAt(nt.end - 1)) ? 2 : 1);
                return Xe(Qe, rt)[rt];
              }
          ...
          function Ur(e, t) {
            e.state.delayingBlurEvent ||
              (e.state.focused &&
                (Ye(e, 'blur', e, t), (e.state.focused = !1), Fe(e.display.wrapper, 'CodeMirror-focused')),
          ...
          function Vn(e) {
            for (
              ...
              if (!a.hidden) {
                ...
                if ((y > 0.005 || y < -0.005) && (i < r && (o -= y), Ft(a.line, u), nl(a.line), a.rest))
                ...
                if (h > e.display.sizerWidth) {
                  ...
                  H > e.display.maxLineLength &&
                    ((e.display.maxLineLength = H), (e.display.maxLine = a.line), (e.display.maxLineChanged = !0));
                }
              }
            }
          ...
          function $n(e, t, n) {
            ...
            if (n && n.ensure) {
              ...
              a < o
                ...
                : Math.min(s, t.lastLine()) >= l && ((o = g(t, er(ge(t, s)) - e.wrapper.clientHeight)), (l = s));
            }
          ...
          function As(e, t, n, r) {
            ...
            for (var o = 0; o < 5; o++) {
              ...
              var u = qi(e, i),
                ...
                v = e.doc.scrollLeft;
              if (
                (u.scrollTop != null && (xn(e, u.scrollTop), Math.abs(e.doc.scrollTop - h) > 1 && (l = !0)),
          ...
          function Fs(e, t) {
            var n = qi(e, t);
            (n.scrollTop != null && xn(e, n.scrollTop), n.scrollLeft != null && Cr(e, n.scrollLeft));
          }
          function qi(e, t) {
            var n = e.display,
              r = jr(e.display);
          ...
          function xn(e, t) {
            Math.abs(e.doc.scrollTop - t) < 2 || (P || Ui(e, { top: t }), ol(e, t, !0), P && Ui(e), kn(e, 100));
          }
          function ol(e, t, n) {
          ...
          function sl(e) {
            (e.display.scrollbars &&
              ...
              e.display.scrollbars.addClass && Fe(e.display.wrapper, e.display.scrollbars.addClass)),
          ...
          function Ws(e) {
            ...
            if (
              ...
              var i = As(t, Me(r, e.scrollToPos.from), Me(r, e.scrollToPos.to), e.scrollToPos.margin);
              Ms(t, i);
            }
          ...
          function ul(e, t) {
            for (var n = t.viewport, r = !0; ; r = !1) {
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                if (
                  (n && n.top != null && (n = { top: Math.min(e.doc.height + Mi(e.display) - Ai(e), n.top) }),
          ...
          function js(e, t, n) {
            ...
            function a(E) {
              var H = E.nextSibling;
              return (
                j && Y && e.display.currentWheelTarget == E ? (E.style.display = 'none') : E.parentNode.removeChild(E),
                H
              );
            }
              ...
              if (!v.hidden)
                if (!v.node || v.node.parentNode != o) {
                  ...
                  (v.changes && (de(v.changes, 'gutter') > -1 && (y = !1), Io(e, v, u, n)),
                    y && (M(v.lineNumber), v.lineNumber.appendChild(document.createTextNode(X(e.options, u)))),
          ...
          function Ks(e, t, n, r) {
            ...
            ((i.mover = d('div', [o], null, 'position: relative')),
              ...
              (i.sizerWidth = null),
              (i.heightForcer = d('div', null, null, 'position: absolute; height: ' + Oe + 'px; width: 1px;')),
                    ...
                    setTimeout(function () {
                      if (l.wheelStartX != null) {
                        var Z = a.scrollLeft - l.wheelStartX,
                          ...
                          ie = (Q && l.wheelDY && Q / l.wheelDY) || (Z && l.wheelDX && Z / l.wheelDX);
                        ((l.wheelStartX = l.wheelStartY = null), ie && ((rr = (rr * ri + ie) / (ri + 1)), ++ri));
                      }
                    }, 200))
          ...
          function gr(e) {
            return e.text
              ? D(e.from.line + e.text.length - 1, xe(e.text).length + (e.text.length == 1 ? e.from.ch : 0))
              : e.to;
          }
          function gl(e, t) {
          ...
          function Qi(e, t, n, r) {
            ...
            if (t.full) (e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length));
              ...
              (o(h, h.text.slice(0, a.ch) + u[0] + v.text.slice(s.ch), i(0)), e.remove(a.line + 1, E));
            else {
          ...
          function kl(e, t, n, r) {
            ...
            if (
              ...
              ((a = xe(l.changes)),
                re(t.from, t.to) == 0 && re(t.from, a.to) == 0 ? (a.to = gr(t)) : l.changes.push(Vi(e, t)));
            else {
              var s = xe(i.done);
              for (
            ...
            for (var r = [], i = 0; i < e.length; ++i) {
              ...
              for (var s = 0; s < l.length; ++s) {
                ...
                if ((a.push({ from: u.from, to: u.to, text: u.text }), t))
                  for (var v in u)
                    (h = v.match(/^spans_(\d+)$/)) && de(t, Number(h[1])) > -1 && ((xe(a)[v] = u[v]), delete u[v]);
              }
            }
            return r;
          }
          ...
          function $s(e, t, n) {
            var r = {
              ...
              update: function (i) {
                this.ranges = [];
                for (var o = 0; o < i.length; o++) this.ranges[o] = new _e(Me(e, i[o].anchor), Me(e, i[o].head));
              },
              origin: n && n.origin,
            };
            return (
          ...
          function li(e, t, n) {
            (Ct(e, 'beforeSelectionChange') || (e.cm && Ct(e.cm, 'beforeSelectionChange'))) && (t = $s(e, t, n));
          ...
          function Al(e, t, n, r) {
            for (var i, o = 0; o < t.ranges.length; o++) {
              ...
              (i || s != l.anchor || u != l.head) && (i || (i = t.ranges.slice(0, o)), (i[o] = new _e(s, u)));
            }
            ...
            return (
              n &&
                (r.update = function (i, o, l, a) {
                  (i && (r.from = Me(e, i)), o && (r.to = Me(e, o)), l && (r.text = l), a !== void 0 && (r.origin = a));
                }),
          ...
          function Ol(e, t) {
            if (!(t.text.length == 1 && t.text[0] == '' && re(t.from, t.to) == 0)) {
              ...
              var r = [];
              vr(e, function (i, o) {
                (!o && de(r, i.history) == -1 && (Bl(i.history, t), r.push(i.history)), Ln(i, t, null, wi(i, t)));
              });
            }
          }
          function si(e, t, n) {
                ...
                for (
                  var v = Ct(e, 'beforeChange') || (e.cm && Ct(e.cm, 'beforeChange')),
                    k = function (H) {
                      ...
                      h.push(Vi(e, Z));
                      var Q = H ? Zi(e, Z) : xe(a);
                      (Ln(e, Z, Q, Sl(e, Z)), !H && e.cm && e.cm.scrollIntoView({ from: Z.from, to: gr(Z) }));
                      var ie = [];
                      vr(e, function (V, ue) {
          ...
          function Ln(e, t, n, r) {
            ...
            if (!(t.from.line > e.lastLine())) {
              if (t.from.line < e.first) {
                ...
                (Pl(e, i),
                  (t = { from: D(e.first, 0), to: D(t.to.line + i, t.to.ch), text: [xe(t.text)], origin: t.origin }));
              }
              var o = e.lastLine();
              (t.to.line > o &&
                (t = { from: t.from, to: D(o, ge(e, o).text.length), text: [t.text[0]], origin: t.origin }),
            ...
            (e.options.lineWrapping ||
              ...
              e.options.lineWrapping ||
                (r.iter(s, o.line + t.text.length, function (y) {
                  var E = Un(y);
                  E > i.maxLineLength && ((i.maxLine = y), (i.maxLineLength = E), (i.maxLineChanged = !0), (a = !1));
                }),
            ...
            if (
              (e.iter(a, n.line + 1, function (v) {
                (s && o.collapsed && !s.options.lineWrapping && qt(v) == s.display.maxLine && (u = !0),
                  ...
                  Xa(v, new Rn(o, a == t.line ? t.ch : null, a == n.line ? n.ch : null), e.cm && e.cm.curOp),
                  ++a);
              }),
              o.collapsed &&
              ...
              o.readOnly && (Ka(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
          ...
          ((kt.prototype = O(Dn.prototype, {
            ...
            setValue: at(function (e) {
              ...
              (Jr(
                this,
                { from: t, to: D(n, ge(this, n).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 },
                !0,
              ),
            ...
            addSelection: at(function (e, t, n) {
              ...
              (r.push(new _e(Me(this, e), Me(this, t || e))), pt(this, Kt(this.cm, r, r.length - 1), n));
            }),
            ...
            replaceSelections: at(function (e, t, n) {
              ...
              for (var a = t && t != 'end' && Gs(this, r, t), s = r.length - 1; s >= 0; s--) Jr(this, r[s]);
              ...
              this.iter(function (n) {
                n.gutterMarkers &&
                  ...
                  Tn(t, n, 'gutter', function () {
                    return ((n.gutterMarkers[e] = null), ve(n.gutterMarkers) && (n.gutterMarkers = null), !0);
                  });
              });
            }),
            lineInfo: function (e) {
...
`
                ...
                if (r && r.length && window.FileReader && window.File)
                  for (
                    var i = r.length,
                      ...
                      s = function (y, E) {
                        if (t.options.allowDropFileTypes && de(t.options.allowDropFileTypes, y.type) == -1) {
                          a();
                          return;
                        }
          ...
          function au(e, t) {
            ...
            if (
              ...
              ((n.src = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='),
                A && ((n.width = n.height = 1), e.display.wrapper.appendChild(n), (n._top = n.offsetTop)),
          ...
          function pu(e, t, n, r) {
            ...
            return Z != null && !(r > 0 && Z == t.text.length) && ((H = E(r > 0 ? 0 : i.length - 1, r, u(Z))), H)
              ? H
              : null;
          }
          var Nn = {
...
`,
          ...
          function Vl(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = x(te(t))), !Ze(t, e))) {
              ...
              (A &&
                ((io = r ? n : null),
                !r && n == 88 && !Hn && (Y ? e.metaKey : e.ctrlKey) && t.replaceSelection('', null, 'cut')),
                P &&
                  !Y &&
                  !r &&
                  n == 46 &&
          ...
          function yu(e) {
            ...
            function n(r) {
              (r.keyCode == 18 || !r.altKey) &&
                (Fe(t, 'CodeMirror-crosshair'), dt(document, 'keyup', n), dt(document, 'mouseover', n));
            }
              ...
              if (re(v, V) != 0)
                if (((v = V), r.unit == 'rectangle')) {
                  ...
                  (ue.length || ue.push(new _e(n, n)),
                    pt(o, Kt(e, s.ranges.slice(0, a).concat(ue), a), { origin: '*mouse', scroll: !1 }),
                    e.scrollIntoView(V));
                } else {
                  var St = l,
                    ft = ra(e, V, r.unit),
          ...
          function ia(e, t) {
            tr(e.display, t) || Mu(e, t) || Ze(e, t, 'contextmenu') || se || e.display.input.onContextMenu(t);
          }
          function Mu(e, t) {
            ...
            ((e.defineOption = n),
              ...
              n('lineSeparator', null, function (r, i) {
                if (((r.doc.lineSep = i), !!i)) {
                  ...
                  for (var a = o.length - 1; a >= 0; a--) Qr(r.doc, i, o[a], D(o[a].line, o[a].ch + i.length));
                }
              }),
              n(
                'specialChars',
            ...
            (ye(t.scroller, 'touchstart', function (s) {
              ...
              ye(t.scroller, 'scroll', function () {
                t.scroller.clientHeight &&
                  (xn(e, t.scroller.scrollTop), Cr(e, t.scroller.scrollLeft, !0), Ye(e, 'scroll', e));
              }),
          ...
          function zn(e, t, n, r) {
            ...
            var v = '',
              k = 0;
            if (e.options.indentWithTabs) for (var y = Math.floor(h / l); y; --y) ((k += l), (v += '	'));
            if ((k < h && (v += et(h - k)), v != u))
...
`) &&
          ...
          function Ou(e) {
            ...
            ((e.prototype = {
              ...
              cursorCoords: function (r, i) {
                ...
                return (
                  r == null ? (o = l.head) : typeof r == 'object' ? (o = Me(this.doc, r)) : (o = r ? l.from() : l.to()),
                  jt(this, o, i || 'page')
                );
              },
              ...
              heightAtLine: function (r, i, o) {
                ...
                if (typeof r == 'number') {
                  ...
                  (r < this.doc.first ? (r = this.doc.first) : r > s && ((r = s), (l = !0)), (a = ge(this.doc, r)));
                } else a = r;
                ...
                ((i.style.top = u + 'px'),
                  ...
                  a == 'right'
                    ...
                    : (a == 'left' ? (h = 0) : a == 'middle' && (h = (s.sizer.clientWidth - i.offsetWidth) / 2),
                      (i.style.left = h + 'px')),
                  o && Fs(this, { left: h, top: u, right: h + i.offsetWidth, bottom: u + i.offsetHeight }));
              },
              ...
              findPosH: function (r, i, o, l) {
                var a = 1;
                i < 0 && ((a = -1), (i = -i));
                for (var s = Me(this.doc, r), u = 0; u < i && ((s = fo(this.doc, s, a, o, l)), !s.hitSide); ++u);
                return s;
              },
          ...
          function fo(e, t, n, r, i) {
            ...
            function u() {
              var ie = t.line + s;
              return ie < e.first || ie >= e.first + e.size ? !1 : ((t = new D(ie, t.ch, t.sticky)), (a = ge(e, ie)));
            }
            function h(ie) {
              var V;
              if (r == 'codepoint') {
                ...
                if (isNaN(ue)) V = null;
                  ...
                  V = new D(t.line, Math.max(0, Math.min(a.text.length, t.ch + n * (be ? 2 : 1))), -n);
                }
...
`)));
            ...
            (je.prototype.showPrimarySelection = function () {
              ...
              if (!(o && !o.bad && l && !l.bad && re(Hr(o, l), r) == 0 && re(yt(o, l), i) == 0)) {
                ...
                (y &&
                  (!P && t.state.focused
                    ? (e.collapse(s.node, s.offset), y.collapsed || (e.removeAllRanges(), e.addRange(y)))
            ...
            (je.prototype.pollContent = function () {
              ...
              var e = this.cm,
                ...
                i = n.to();
              if (
                (r.ch == 0 && r.line > e.firstLine() && (r = D(r.line - 1, ge(e.doc, r.line - 1).length)),
                i.ch == ge(e.doc, i.line).text.length && i.line < e.lastLine() && (i = D(i.line + 1, 0)),
              ...
              if (
                ...
                return !1;
              for (
                var v = e.doc.splitLines(Iu(e, a, h, l, u)), k = Vt(e.doc, D(l, 0), D(u, ge(e.doc, u).text.length));
              ...
              for (
                var ie = xe(v),
                  V = xe(k),
                  ue = Math.min(ie.length - (v.length == 1 ? y : 0), V.length - (k.length == 1 ? y : 0));
                E < ue && ie.charCodeAt(ie.length - E - 1) == V.charCodeAt(V.length - E - 1);

              )
                ++E;
              if (v.length == 1 && k.length == 1 && l == r.line)
                for (; y && y > r.ch && ie.charCodeAt(ie.length - E - 1) == V.charCodeAt(V.length - E - 1); )
                  (y--, E++);
          ...
          function Iu(e, t, n, r, i) {
            ...
            function k(y) {
              ...
              } else y.nodeType == 3 && v(y.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
            }
          ...
          function pi(e, t, n) {
            ...
            if (t == e.display.lineDiv) {
              if (((r = e.display.lineDiv.childNodes[n]), !r)) return rn(e.clipPos(D(e.display.viewTo - 1)), !0);
              ((t = null), (n = 0));
            } else
...
`)),
            ...
            ($e.prototype.reset = function (e) {
              if (!(this.contextMenuPending || (this.composing && e))) {
                ...
                } else e || ((this.prevInput = this.textarea.value = ''), b && W >= 9 && (this.hasSelection = null));
                this.resetting = !1;
              }
            }),
            ...
            ($e.prototype.focus = function () {
              if (this.cm.options.readOnly != 'nocursor' && (!_ || x(ke(this.textarea)) != this.textarea))
                try {
                  this.textarea.focus();
                } catch {}
            }),
        ...
        (function (C) {
          ...
          C.defineMode('css', function (se, q) {
            ...
            function Oe(T, U) {
              ...
              if (/\d/.test(O) || (O == '.' && T.eat(/\d/))) return (T.eatWhile(/[\w.%]/), de('number', 'unit'));
              if (O === '-') {
                if (/[\d.]/.test(T.peek())) return (T.eatWhile(/[\w.%]/), de('number', 'unit'));
                if (T.match(/^-[\w\\\-]*/))
                  return (
                    T.eatWhile(/[\w\\\-]/),
                    T.match(/^\s*:/, !1) ? de('variable-2', 'variable-definition') : de('variable-2', 'variable')
                  );
                ...
                return /[,+>*\/]/.test(O)
                  ...
                  : O == '.' && T.match(/^-?[_a-z][_a-z0-9-]*/i)
                    ...
                    : /[:;{}\[\]\(\)]/.test(O)
                      ? de(null, O)
                      : T.match(/^[\w-.]+(?=\()/)
                        ? (/^(url(-prefix)?|domain|regexp)$/i.test(T.current()) && (U.tokenize = Ve),
            ...
            function qe(T) {
              return function (U, O) {
                ...
                return ((he == T || (!ze && T != ')')) && (O.tokenize = null), de('string', 'string'));
              };
            }
            function Ve(T, U) {
              return (
            ...
            function xe(T) {
              ...
              te.hasOwnProperty(U) ? (we = 'atom') : c.hasOwnProperty(U) ? (we = 'keyword') : (we = 'variable');
            }
            var Ie = {};
            return (
              (Ie.top = function (T, U, O) {
                ...
                if (/^@(media|supports|(-moz-)?document|import)$/i.test(T)) return Pe(O, U, 'atBlock');
                if (/^@(font-face|counter-style)/i.test(T)) return ((O.stateArg = T), 'restricted_atBlock_before');
              ...
              (Ie.prop = function (T, U, O) {
                ...
                if (T == 'hash' && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(U.current()))
                  we += ' error';
                else if (T == 'word') xe(U);
              ...
              (Ie.propBlock = function (T, U, O) {
                return T == '}' ? Re(O) : T == 'word' ? ((we = 'property'), 'maybeprop') : O.context.type;
              }),
              ...
              (Ie.pseudo = function (T, U, O) {
                return T == 'meta' ? 'pseudo' : T == 'word' ? ((we = 'variable-3'), O.context.type) : Ue(T, U, O);
              }),
              ...
              (Ie.atBlock_parens = function (T, U, O) {
                return T == ')' ? Re(O) : T == '{' || T == '}' ? et(T, U, O, 2) : Ie.atBlock(T, U, O);
              }),
              ...
              (Ie.restricted_atBlock = function (T, U, O) {
                return T == '}'
                  ...
                  : T == 'word'
                    ? ((O.stateArg == '@font-face' && !ne.hasOwnProperty(U.current().toLowerCase())) ||
                      (O.stateArg == '@counter-style' && !p.hasOwnProperty(U.current().toLowerCase()))
                        ? (we = 'error')
                        : (we = 'property'),
                      'maybeprop')
                    : 'restricted_atBlock';
              ...
              (Ie.keyframes = function (T, U, O) {
                return T == 'word' ? ((we = 'variable'), 'keyframes') : T == '{' ? Pe(O, U, 'top') : Ue(T, U, O);
              }),
              ...
              (Ie.interpolation = function (T, U, O) {
                return T == '}'
                  ...
                  : T == '{' || T == ';'
                    ? et(T, U, O)
                    : (T == 'word' ? (we = 'variable') : T != 'variable' && T != '(' && T != ')' && (we = 'error'),
                      'interpolation');
              }),
              {
          ...
          var P = ['domain', 'regexp', 'url', 'url-prefix'],
            fe = De(P),
            Se = ['all', 'aural', 'braille', 'handheld', 'print', 'projection', 'screen', 'tty', 'tv', 'embossed'],
            le = De(Se),
            b = [
              'width',
              'min-width',
            ...
            C.defineMIME('text/x-scss', {
              ...
              tokenHooks: {
                ...
                $: function (se) {
                  return (
                    se.match(/^[\w-]+/),
                    se.match(/^\s*:/, !1) ? ['variable-2', 'variable-definition'] : ['variable-2', 'variable']
                  );
                },
                '#': function (se) {
        ...
        (function (C) {
          ...
          (C.defineMode('xml', function (fe, Se) {
            ...
            function A(d, S) {
              var L = d.next();
              if (L == '>' || (L == '/' && d.eat('>')))
                return ((S.tokenize = B), (oe = L == '>' ? 'endTag' : 'selfcloseTag'), 'tag bracket');
            ...
            function Y(d, S) {
              for (var L; ; ) {
                if (
                  !d.context ||
                  ((L = d.context.tagName),
                  !b.contextGrabbers.hasOwnProperty(N(L)) || !b.contextGrabbers[N(L)].hasOwnProperty(N(S)))
                )
                  return;
                _(d);
              }
            ...
            return {
              startState: function (d) {
                var S = { tokenize: B, state: ce, indented: d || 0, tagName: null, tagStart: null, context: null };
              ...
              token: function (d, S) {
                ...
                return (
                  (L || oe) &&
                    L != 'comment' &&
                    ((w = null), (S.state = S.state(oe || L, d, S)), w && (L = w == 'error' ? L + ' error' : w)),
                  L
                );
              },
              indent: function (d, S, L) {
                var m = d.context;
                if (d.tokenize.isInAttribute) return d.tagStart == d.indented ? d.stringStartCol + 1 : d.indented + le;
        ...
        (function (C) {
          ...
          (C.defineMode('javascript', function (De, P) {
            var fe = De.indentUnit,
              ...
              B = /[+\-*&%=<>!?|~^@]/,
              A = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
            function K(f) {
            ...
            function R(f, g) {
              ...
              if (I == '.' && f.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return N('number', 'number');
              if (I == '.' && f.match('..')) return N('spread', 'meta');
              if (/[\[\]{}\(\),;\:\.]/.test(I)) return N(I);
              if (I == '=' && f.eat('>')) return N('=>', 'operator');
              if (I == '0' && f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return N('number', 'number');
              if (/\d/.test(I))
                return (f.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), N('number', 'number'));
              if (I == '/')
                return f.eat('*')
                  ? ((g.tokenize = Y), Y(f, g))
                  : f.eat('/')
                    ...
                    : Ft(f, g, 1)
                      ? (K(f), f.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), N('regexp', 'string-2'))
              ...
              if ((I == '<' && f.match('!--')) || (I == '-' && f.match('->') && !/\S/.test(f.string.slice(0, f.start))))
            ...
            function _(f) {
              return function (g, I) {
                var X = !1,
                  D;
                if (le && g.peek() == '@' && g.match(A)) return ((I.tokenize = R), N('jsonld-keyword', 'meta'));
            ...
            function ee(f, g) {
              ...
              if (!(I < 0)) {
                if (j) {
                  var X = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(f.string.slice(f.start, I));
                  X && (I = X.index);
                }
            ...
            function c() {
              ((M.state.context = new z(M.state.context, M.state.localVars, !1)), (M.state.localVars = p));
            }
            function te() {
              ((M.state.context = new z(M.state.context, M.state.localVars, !0)), (M.state.localVars = null));
            }
            c.lex = te.lex = !0;
            function ke() {
            ...
            function J(f, g) {
              var I = function () {
                ...
                else for (var re = X.lexical; re && re.type == ')' && re.align; re = re.prev) D = re.indented;
                              ...
                              : f == 'function'
                                ...
                                : f == 'for'
                                  ...
                                  : f == 'class' || (j && g == 'interface')
                                    ? ((M.marked = 'keyword'), d(J('form', f == 'class' ? f : g), Pr, pe))
                                    : f == 'variable'
                                      ? j && g == 'declare'
                                        ...
                                        : j &&
                                          ...
                                          : j && g == 'namespace'
                                            ...
                                            : j && g == 'abstract'
                                              ...
                                              : d(J('stat'), ze)
                                      : f == 'switch'
                                        ? d(J('form'), qe, Te('{'), J('}', 'switch'), te, Pt, pe, pe, ke)
                                        : f == 'case'
                                          ? d(de, Te(':'))
                                          : f == 'default'
                                            ? d(Te(':'))
            ...
            function T(f) {
              return function (g) {
                return g == '.' ? d(f ? O : U) : g == 'variable' && j ? d(Ct, f ? Re : Pe) : G(f ? Oe : de);
              };
            }
            function U(f, g) {
            ...
            function lr(f) {
              if (j && f == ':') return M.stream.match(/^\s*\w+\s+is\b/, !1) ? d(de, mi, We) : d(We);
            }
            function mi(f, g) {
            ...
            function ar(f, g) {
              return f == 'variable' && !M.stream.match(/^\s*:/, !1)
                ...
                : (f == 'variable' && (M.marked = 'property'),
                  f == 'spread' ? d(xt) : f == '}' ? G() : f == '[' ? d(de, Te(']'), Te(':'), ar) : d(Te(':'), xt, Wt));
            }
            function ln() {
              return G(xt, Wt);
            }
            ...
            function Rt(f, g) {
              ...
              if (f == 'variable' || M.style == 'keyword') return ((M.marked = 'property'), d(kr, Rt));
            ...
            function Br(f, g) {
              return f == '{' ? Tt(Br, '}') : (f == 'variable' && L(g), g == '*' && (M.marked = 'keyword'), d(sn));
            }
            function Gt(f) {
              if (f == ',') return d(Br, Gt);
            }
            ...
            function un(f, g) {
              return f.lastType == 'operator' || f.lastType == ',' || B.test(g.charAt(0)) || /[,.]/.test(g.charAt(0));
            }
            function Ft(f, g, I) {
              return (
                (g.tokenize == R &&
            ...
            return {
              startState: function (f) {
                ...
                return (P.globalVars && typeof P.globalVars == 'object' && (g.globalVars = P.globalVars), g);
              },
              token: function (f, g) {
                if (
                  (f.sol() &&
                ...
                return ae == 'comment'
                  ? I
                  : ((g.lastType = ae == 'operator' && (F == '++' || F == '--') ? 'incdec' : ae), Fe(g, I, ae, F, f));
              },
              indent: function (f, g) {
                ...
                for (
                  ...
                  (I == '}' || ((D = f.cc[f.cc.length - 1]) && (D == Pe || D == Re) && !/^[,\.=+\-*:?[\(]/.test(g)));
                ...
                var it = X.type,
                  yt = I == it;
                return it == 'vardef'
                  ? X.indented + (f.lastType == 'operator' || f.lastType == ',' ? X.info.length + 1 : 0)
                  : it == 'form' && I == '{'
                    ? X.indented
                    : it == 'form'
                      ? X.indented + fe
    ...
    ka ||
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          function W(oe, w) {
            for (var B in oe)
              for (var A = w[B] || (w[B] = []), K = oe[B], ae = K.length - 1; ae >= 0; ae--) A.unshift(K[ae]);
          }
          function j(oe, w) {
          ...
          (C.defineMode(
            ...
            function (oe, w) {
              ...
              if ((W(De, A), K && W(K, A), ae))
                for (var F = ae.length - 1; F >= 0; F--) A.script.unshift(['type', ae[F].matches, ae[F].mode]);
              function N(R, _) {
          ...
          (C.defineMode('python', function (W, j) {
            ...
            function $(S, L) {
              ...
              if ((m && (L.indent = S.indentation()), m && le(L).type == 'py')) {
                ...
                if (S.eatSpace()) {
                  var z = S.indentation();
                  return (z > x ? q(L) : z < x && M(S, L) && S.peek() != '#' && (L.errorToken = !0), null);
                } else {
                  var ne = ee(S, L);
                ...
                return function (c, te) {
                  ...
                  return (
                    ke == 'punctuation' &&
                      (c.current() == '{'
                        ? (te.tokenize = z(p + 1))
                        : c.current() == '}' && (p > 1 ? (te.tokenize = z(p - 1)) : (te.tokenize = ne))),
                    ke
                  );
                };
              }
              function ne(p, c) {
                for (; !p.eol(); )
                  if ((p.eatWhile(/[^'"\{\}\\]/), p.eat('\\'))) {
                    ...
                    if (p.match('{{')) return x;
                    if (p.match('{', !1)) return ((c.tokenize = z(0)), p.current() ? x : c.tokenize(p, c));
                    if (p.match('}}')) return x;
            ...
            function G(S, L) {
              ...
              var m = L.tokenize(S, L),
                x = S.current();
              if (L.beginningOfLine && x == '@') return S.match(R, !1) ? 'meta' : N ? 'operator' : oe;
              if (
              ...
              return (L.dedent && S.eol() && le(L).type == 'py' && L.scopes.length > 1 && L.scopes.pop(), m);
            }
            var d = {
              ...
              token: function (S, L) {
                ...
                var x = G(S, L);
                return (
                  x && x != 'comment' && (L.lastToken = x == 'keyword' || x == 'punctuation' ? S.current() : x),
              ...
              indent: function (S, L) {
                ...
                var m = le(S),
                  x =
                    m.type == L.charAt(0) || (m.type == 'py' && !S.dedent && /^(else:|elif |except |finally:)/.test(L));
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          function P(m, x, z, ne) {
            var p = m.indented;
            return (
              m.context && m.context.type == 'statement' && z != 'statement' && (p = m.context.indented),
          ...
          C.defineMode('clike', function (m, x) {
            var z = m.indentUnit,
              ...
              ct = x.numberStart || /[\d\.]/,
              Pe = x.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
              Re = x.isOperatorChar || /[+\-*&%=<>!?|\/]/,
            ...
            function ze(he, Le) {
              x.typeFirstDefinitions && he.eol() && le(Le.context) && (Le.typeAtEndOfLine = Se(he, Le, he.pos));
            }
            return {
              ...
              token: function (he, Le) {
                ...
                if (
                  (he.sol() &&
                    (ve.align == null && (ve.align = !1), (Le.indented = he.indentation()), (Le.startOfLine = !0)),
                  he.eatSpace())
                )
                ...
                if (
                  (Be == 'variable' &&
                    (Le.prevToken == 'def' ||
                      (x.typeFirstDefinitions && Se(he, Le, he.start) && le(Le.context) && he.match(/^\s*\(/, !1))) &&
                    (Be = 'def'),
                  Ce.token)
                ) {
              ...
              indent: function (he, Le) {
                if ((he.tokenize != T && he.tokenize != null) || (he.typeAtEndOfLine && le(he.context))) return C.Pass;
                var ve = he.context,
                  Be = Le && Le.charAt(0),
                  Ee = Be == ve.type;
                if ((ve.type == 'statement' && Be == '}' && (ve = ve.prev), x.dontIndentStatements))
                  for (; ve.type == 'statement' && x.dontIndentStatements.test(ve.info); ) ve = ve.prev;
                if (Ce.indent) {
                ...
                return ve.type == 'statement'
                  ...
                  : ve.align && (!p || ve.type != ')')
                    ...
                    : ve.type == ')' && !Ee
                      ? ve.indented + ne
                      : ve.indented + (Ee ? 0 : z) + (!Ee && Pt && !/^(?:case|default)\b/.test(Le) ? z : 0);
              },
          ...
          (Fe(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
            ...
            Fe('text/x-csharp', {
              ...
              hooks: {
                '@': function (m, x) {
                  return m.eat('"') ? ((x.tokenize = se), se(m, x)) : (m.eatWhile(/[\w\$_]/), 'meta');
                },
              },
            }));
          function M(m, x) {
          ...
          function G(m) {
            return function (x, z) {
              for (var ne; (ne = x.next()); )
                ...
                else if (ne == '/' && x.eat('*')) return ((z.tokenize = G(m + 1)), z.tokenize(x, z));
              return 'comment';
            };
          }
          Fe('text/x-scala', {
            ...
            hooks: {
              ...
              '=': function (m, x) {
                ...
                return z.type == '}' && z.align && m.eat('>')
                  ? ((x.context = new De(z.indented, z.column, z.type, z.info, null, z.prev)), 'operator')
                  : !1;
              },
              '/': function (m, x) {
          ...
          function d(m) {
            return function (x, z) {
              for (var ne = !1, p, c = !1; !x.eol(); ) {
                ...
                ((p = x.next()), !ne && p == '$' && x.match('{') && x.skipTo('}'), (ne = !ne && p == '\\' && !m));
              }
          ...
          (Fe('text/x-kotlin', {
            ...
            hooks: {
              ...
              indent: function (m, x, z, ne) {
                ...
                if (x.align && x.type == '}') return x.indented + (m.context.type == (z || '').charAt(0) ? 0 : ne);
              },
            },
            ...
            Fe('text/x-objectivec', {
              ...
              types: F,
              builtin: b(B),
              blockKeywords: b(N + ' @synthesize @try @catch @finally @autoreleasepool @synchronized'),
            ...
            Fe('text/x-objectivec++', {
              ...
              types: F,
              builtin: b(B),
              blockKeywords: b(N + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch'),
          ...
          ((C.findModeByMIME = function (fe) {
            ...
            (C.findModeByName = function (fe) {
              ...
              for (var Se = 0; Se < C.modeInfo.length; Se++) {
                ...
                if (le.alias) {
                  for (var b = 0; b < le.alias.length; b++) if (le.alias[b].toLowerCase() == fe) return le;
                }
              }
            }));
        });
          ...
          (C.defineMode(
            ...
            function (De, P) {
              ...
              (P.highlightFormatting === void 0 && (P.highlightFormatting = !1),
                ...
                P.fencedCodeBlockDefaultMode === void 0 && (P.fencedCodeBlockDefaultMode = 'text/plain'),
              ...
              for (var W in b) b.hasOwnProperty(W) && P.tokenTypeOverrides[W] && (b[W] = P.tokenTypeOverrides[W]);
              var j = /^([*\-_])(?:\s*\1){2,}\s*$/,
                oe = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                w = /^\[(x| )\](?=\s)/i,
              ...
              function ee(p, c) {
                ...
                var de = !ke && !pe && !c.prevLine.header && (!Te || !J) && !c.prevLine.fencedCodeEnd,
                  Oe = (c.list === !1 || pe || ke) && c.indentation <= Ce && p.match(j),
                  qe = null;
                if (c.indentationDiff >= 4 && (J || c.prevLine.fencedCodeEnd || c.prevLine.header || ke))
                ...
                if (!Oe && !c.setext && te && c.indentation <= Ce && (qe = p.match(oe))) {
                  ...
                  if (te && c.indentation <= Ce && (qe = p.match(ae, !0)))
                    return (
                      ...
                      (c.localMode = P.fencedCodeBlockHighlighting && le(qe[2] || P.fencedCodeBlockDefaultMode)),
                ...
                if (p.formatting) {
                  ...
                  for (var te = 0; te < p.formatting.length; te++)
                    (c.push(b.formatting + '-' + p.formatting[te]),
                      p.formatting[te] === 'header' && c.push(b.formatting + '-' + p.formatting[te] + '-' + p.header),
              ...
              function M(p, c) {
                ...
                if (J === ']' && c.linkText) {
                  ...
                  var Oe = q(c);
                  return ((c.linkText = !1), (c.inline = c.f = p.match(/\(.*?\)| ?\[.*?\]/, !1) ? d : M), Oe);
                }
                ...
                if (J === '*' || J === '_') {
                  for (var Pe = 1, Re = p.pos == 1 ? ' ' : p.string.charAt(p.pos - 2); Pe < 3 && p.eat(J); ) Pe++;
                  var Ue = p.peek() || ' ',
                  ...
                  if (
                    ...
                    (P.highlightFormatting && (c.formatting = Ie == null ? 'strong' : T == null ? 'em' : 'strong em'),
                      Ie === !0 && (c.em = J),
                      T === !0 && (c.strong = J));
                    var de = q(c);
                ...
                if (P.strikethrough) {
                  if (J === '~' && p.eatWhile(J)) {
                    if (c.strikethrough) {
                      ...
                      return ((c.strikethrough = !0), P.highlightFormatting && (c.formatting = 'strikethrough'), q(c));
                  } else if (J === ' ' && p.match('~~', !0)) {
                    if (p.peek() === ' ') return q(c);
                    p.backUp(2);
                  }
                }
                if (P.emoji && J === ':' && p.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
              ...
              function L(p) {
                return function (c, te) {
                  var ke = c.next();
                  if (ke === p) {
                    ((te.f = te.inline = M), P.highlightFormatting && (te.formatting = 'link-string'));
                    var J = q(te);
              ...
              function m(p, c) {
                return p.match(/^([^\]\\]|\\.)*\]:/, !1)
                  ? ((c.f = x), p.next(), P.highlightFormatting && (c.formatting = 'link'), (c.linkText = !0), q(c))
                  : _(p, c, M);
              }
              function x(p, c) {
                if (p.match(']:', !0)) {
    ...
    Ea ||
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          function De(W) {
            W.state.placeholder &&
              (W.state.placeholder.parentNode.removeChild(W.state.placeholder), (W.state.placeholder = null));
          }
          function P(W) {
            De(W);
          ...
          function le(W) {
            var j = W.getWrapperElement(),
              oe = b(W);
            ((j.className = j.className.replace(' CodeMirror-empty', '') + (oe ? ' CodeMirror-empty' : '')),
              oe ? P(W) : De(W));
          }
          function b(W) {
        ...
        (function (C) {
          ...
          ((C.defineSimpleMode = function (w, B) {
            ...
            (C.simpleMode = function (w, B) {
              ...
              var ce = {
                startState: function () {
                  return { state: 'start', pending: null, local: null, localState: null, indent: ae ? [] : null };
                },
                copyState: function (ee) {
                  ...
                  for (var se = ee.persistentStates; se; se = se.next)
                    Ae.persistentStates = {
                      mode: se.mode,
                      spec: se.spec,
                      state: se.state == ee.localState ? Ae.localState : C.copyState(se.mode, se.state),
          ...
          function le(w, B) {
            return function (A, K) {
              if (K.pending) {
                ...
                return (K.pending.length == 0 && (K.pending = null), (A.pos += ae.text.length), ae.token);
              }
              if (K.local)
                if (K.local.end && A.match(K.local.end)) {
                  ...
                  var F = K.local.mode.token(A, K.localState),
                    N;
                  return (K.local.endScan && (N = K.local.endScan.exec(A.current())) && (A.pos = A.start + N.index), F);
                }
              for (var R = w[K.state], _ = 0; _ < R.length; _++) {
                ...
                if (ce) {
                  ...
                  var $ = Y.token;
                  if (($ && $.apply && ($ = $(ce)), ce.length > 2 && Y.token && typeof Y.token != 'string')) {
                    for (var ee = 2; ee < ce.length; ee++)
                      ce[ee] && (K.pending || (K.pending = [])).push({ text: ce[ee], token: Y.token[ee - 1] });
          ...
          function oe(w, B) {
            return function (A, K, ae) {
              ...
              if (A.indent == null || A.local || (B.dontIndentStates && j(A.state, B.dontIndentStates) > -1))
                return C.Pass;
              ...
              e: for (;;) {
                for (var R = 0; R < N.length; R++) {
                  ...
                  if (_.data.dedent && _.data.dedentIfLineStart !== !1) {
                    ...
                    if (Y && Y[0]) {
                      (F--, (_.next || _.push) && (N = w[_.next || _.push]), (K = K.slice(Y[0].length)));
                      continue e;
                    }
                  }
                }
    ...
    Ia ||
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          var De = /MSIE \d/.test(navigator.userAgent) && (document.documentMode == null || document.documentMode < 8),
            P = C.Pos,
            fe = { '(': ')>', ')': '(<', '[': ']>', ']': '[<', '{': '}>', '}': '{<', '<': '>>', '>': '<<' };
          function Se(w) {
          ...
          function le(w, B, A) {
            ...
            return ce == null
              ? null
              : { from: P(B.line, ae), to: ce && ce.pos, match: ce && ce.ch == R.charAt(0), forward: _ > 0 };
          }
          function b(w, B, A, K, ae) {
            for (
              var F = (ae && ae.maxScanLineLength) || 1e4,
                ...
                R = [],
                _ = Se(ae),
                Y = A > 0 ? Math.min(B.line + N, w.lastLine() + 1) : Math.max(w.firstLine() - 1, B.line - N),
                ce = B.line;
              ce != Y;
              ce += A
            ) {
              ...
              if ($) {
                ...
                if (!($.length > F))
                  for (ce == B.line && (ee = B.ch - (A < 0 ? 1 : 0)); ee != Ae; ee += A) {
                    var se = $.charAt(ee);
                    if (_.test(se) && (K === void 0 || (w.getTokenTypeAt(P(ce, ee + 1)) || '') == (K || ''))) {
                      var q = fe[se];
          ...
          function j(w) {
            w.operation(function () {
              (w.state.matchBrackets.currentlyHighlighted &&
                (w.state.matchBrackets.currentlyHighlighted(), (w.state.matchBrackets.currentlyHighlighted = null)),
          ...
          (C.defineOption('matchBrackets', !1, function (w, B, A) {
            (A && A != C.Init && (w.off('cursorActivity', j), w.off('focus', j), w.off('blur', oe), oe(w)),
              B &&
            ...
            C.defineExtension('findMatchingBracket', function (w, B, A) {
              return (
                (A || typeof B == 'boolean') && (A ? ((A.strict = B), (B = A)) : (B = B ? { strict: !0 } : null)),
                le(this, w, B)
              );
            }),
    ...
    Ba ||
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          function fe(F, N) {
            return N == 'pairs' && typeof F == 'string' ? F : typeof F == 'object' && F[N] != null ? F[N] : De[N];
          }
...
`;
          ...
          function w(F, N) {
            for (var R = [], _ = F.listSelections(), Y = 0, ce = 0; ce < _.length; ce++) {
              ...
              var ee = $.head.ch || N > 0 ? { line: $.head.line, ch: $.head.ch + N } : { line: $.head.line - 1 };
              ...
              if (se && !M.empty()) d = 'surround';
                ...
                ee && ae(F, G)
                  ...
                  : $.indexOf(N) >= 0 && F.getRange(G, P(G.line, G.ch + 3)) == N + N + N
                    ? (d = 'skipThree')
                    : (d = 'skip');
              else if (ee && G.ch > 1 && $.indexOf(N) >= 0 && F.getRange(P(G.line, G.ch - 2), G) == N + N) {
                if (G.ch > 2 && /\bstring/.test(F.getTokenTypeAt(P(G.line, G.ch - 2)))) return C.Pass;
                d = 'addFour';
              } else if (ee) {
          ...
          function ae(F, N) {
            ...
            return /\bstring/.test(R.type) && R.start == N.ch && (N.ch == 0 || !/\bstring/.test(F.getTokenTypeAt(N)));
          }
        });
      })()),
    za.exports
